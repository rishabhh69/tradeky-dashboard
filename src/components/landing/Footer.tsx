            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  key={social.label}
                  href={social.href}
                  className="flex h-10 w-10 items-center justify-center rounded-lg glass-card text-muted-foreground hover:text-foreground hover:bg-white/10 transition-colors"
